...
namespace Elonmusk 
{
    ...
    public class Item : Stat
    {
        ...
        //전용 무기
        public enum ClassType { ALL, WARRIOR, ARCHER };

        public ClassType classType = ClassType.ALL;
        ...
        //새로 추가
        public Item(string name, string desc, int ATK, int DEF, int GOLD, ItemType thisType, ClassType thisClass)
        {
            this.name = name;
            this.desc = desc;
            this.ATK = ATK;
